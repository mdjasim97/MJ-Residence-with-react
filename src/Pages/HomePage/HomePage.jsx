...
const HomePage = () => {
  ...
  return (
    <div>
      ...
      <div>
        <h1 className="text-center text-3xl lg:text-5xl font-bold mt-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 my-14">
          {residential.map((residential, indx) => (
            <Residential key={indx} residential={residential}></Residential>
          ))}
        </div>
      </div>
        ...
        <div>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
            <div className="relative">
              <img
                className="max-h-60 flex-1 w-full brightness-50"
                src={miami}
                alt=""
              />
            ...
            <div className="relative">
              <img
                className="max-h-60 brightness-50 flex-1 w-full"
                src={los_angeless}
                alt=""
              />
              <div className="absolute text-center top-1/2 right-1/2 text-white text-2xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 mt-5">
            ...
            <div className="relative">
              <img
                className="min-h-60 brightness-50 flex-1 w-full"
                src={florida}
                alt=""
              />
              <div className="absolute text-center top-1/2 right-1/2 text-white text-2xl">
